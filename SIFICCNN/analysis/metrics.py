...
def print_classifier_summary(y_scores, y_true, run_name=""):
    ...
    tp_opt, fp_opt, tn_opt, fn_opt = get_confusion_matrix_entries(y_scores, y_true, theta=theta)
    ...
    print("Accuracy (weighted)  : {:.2f} +/- {:.2f} %".format(acc_w * 100, acc_w_unc * 100))
    print("")

    print("# Threshold: {:.3f}".format(theta))
    print("Efficiency           : {:.2f} +/- {:.2f} %".format(eff_opt * 100, eff_opt_unc * 100))
    print("Purity               : {:.2f} +/- {:.2f} %".format(pur_opt * 100, pur_opt_unc * 100))
    print("Accuracy             : {:.2f} +/- {:.2f} %".format(acc_opt * 100, acc_opt_unc * 100))
    print("Accuracy (weighted)  : {:.2f} +/- {:.2f} %".format(acc_opt_w * 100, acc_opt_w_unc * 100))
