...
from tensorflow.keras.layers import Dense, Dropout, Concatenate, Input, Reshape
from spektral.layers import EdgeConv, GlobalMaxPool

from SIFICCNN.utils.layers import EdgeConvResNetBlockV2
...
def SiFiECRNShortReshape(F=10,
    ...
    dense = Dense(n_out, activation=activation_out)(x)

    out = Reshape(shape)(dense)
